        ...
        <Button
          onClick={() => {
            if (onUpgrade) {
              ...
              // Default behavior - open Microsoft Marketplace subscription page
              window.open('https://marketplace.microsoft.com/en-us/product/saas/optimusinfo.rfp-saas', '_blank');
            }
            onClose();
          }}
          variant="contained"
