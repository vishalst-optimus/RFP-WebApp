                ...
                <LinearProgress
                  ...
                  sx={{
                    ...
                    '& .MuiLinearProgress-bar': {
                      backgroundColor: theme.palette.mode === 'light' ? '#2196F3' : '#1976D2',
                      borderRadius: 6,
                    },
                  }}
                />
        ...
        <Grid item xs={12} sm={4}>
          <Paper
            sx={{
              p: { xs: 2, sm: 3 },
              textAlign: 'center',
              backgroundColor: theme.palette.mode === 'light' ? '#FFF3E0' : '#2a2a2a',
        ...
        <Grid item xs={12} sm={4}>
          <Paper
            sx={{
              p: { xs: 2, sm: 3 },
              textAlign: 'center',
              backgroundColor: theme.palette.mode === 'light' ? '#E8F5E8' : '#2a2a2a',
