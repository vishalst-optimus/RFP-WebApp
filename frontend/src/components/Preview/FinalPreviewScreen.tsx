  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ textAlign: 'center', mb: 4 }}>
        <CompleteIcon sx={{ fontSize: 48, color: theme.palette.success.main, mb: 2 }} />
  ...
  <Grid container spacing={{ xs: 2, md: 3 }} sx={{ mb: 4, justifyContent: 'center', textAlign: 'center' }}>
        <Grid item xs={6} sm={6} md={3}>
          <Paper 
            sx={{ 
              p: { xs: 1.5, sm: 2 }, 
              textAlign: 'center', 
              backgroundColor: sectionsCompleted === totalSections 
                ? theme.palette.mode === 'light' ? '#E8F5E8' : theme.palette.success.dark + '40'
                : theme.palette.mode === 'light' ? '#FFEBEE' : theme.palette.error.dark + '40',
              border: `2px solid ${sectionsCompleted === totalSections ? theme.palette.success.main : theme.palette.error.main}`,
          ...
          >
            <Typography 
              variant="h4" 
              sx={{ 
                color: sectionsCompleted === totalSections ? theme.palette.success.main : theme.palette.error.main, 
                fontWeight: 700,
        ...
        <Grid item xs={6} sm={6} md={3}>
          <Paper sx={{ 
            p: { xs: 1.5, sm: 2 }, 
            textAlign: 'center', 
            backgroundColor: theme.palette.mode === 'light' ? '#E3F2FD' : theme.palette.primary.dark + '40',
            minHeight: { xs: '120px', md: '140px' }
          }}>
            <Typography 
              variant="h4" 
        ...
        return (
          ...
          >
            <AccordionSummary 
              ...
              sx={{ 
                backgroundColor: isClientSection 
                  ? theme.palette.mode === 'light' ? '#E8F5E8' : theme.palette.success.dark + '40'
                  : theme.palette.mode === 'light' ? '#F8F9FA' : theme.palette.action.hover,
                borderLeft: `4px solid ${isClientSection ? theme.palette.success.main : getConfidenceColor(confidence)}`,
              }}
            >
            ...
            <AccordionDetails sx={{ p: 3 }}>
              ...
              {section.completion_notes && (
                <Box sx={{ mt: 2, p: 2, backgroundColor: theme.palette.warning.light, borderRadius: 1 }}>
                  <Typography variant="body2" sx={{ fontWeight: 600, color: theme.palette.warning.main, mb: 1 }}>
                    📝 Analysis Notes:
                  </Typography>
